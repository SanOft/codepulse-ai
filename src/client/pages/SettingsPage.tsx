  ...
  return (
    <PageContainer>
      <div>
        <PageHeader>
          ...
          <div>
            ...
            <PageSubtitle>
              Configure your daily and monthly budget limits, API call frequencies, and API mode settings.
            </PageSubtitle>
          </div>
        </PageHeader>
      </div>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <InputWrapper>
            ...
            <InputDescription>
              Maximum amount you can spend per day. Reviews will be blocked once this limit is reached.
            </InputDescription>
          </InputWrapper>
          ...
          <InputWrapper>
            ...
            <InputDescription>
              Maximum amount you can spend per month. Resets on the 1st of each month.
            </InputDescription>
          </InputWrapper>
          ...
          <InfoAlert>
            ...
            <InfoContent>
              ...
              <InfoText>
                When you reach 80% of your daily or monthly limit, you'll receive a warning. At 100%, all reviews will be blocked until the next period.
              </InfoText>
            </InfoContent>
          </InfoAlert>
        </div>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <InputWrapper>
            ...
            />
            <InputDescription>
              Maximum number of code review requests allowed per day. Prevents accidental overuse.
            </InputDescription>
          </InputWrapper>

          <ToggleWrapper style={{ borderTop: '1px solid rgba(148, 163, 184, 0.2)', paddingTop: '16px' }}>
            <ToggleContent>
      ...
      <HelpCard>
        <HelpHeader>
          <HelpCircle size={18} />
          <h3 style={{ margin: 0, fontSize: '16px', fontWeight: 600 }}>Need Help?</h3>
        </HelpHeader>
        <HelpList>
          <HelpItem>
            <HelpItemTitle>
              <strong>Budget Limits:</strong> Set spending caps to prevent unexpected charges. The system will block reviews once limits are reached.
            </HelpItemTitle>
          </HelpItem>
          <HelpItem>
            <HelpItemTitle>
              <strong>API Calls:</strong> Limit the number of reviews per day to control usage patterns and prevent accidental bulk submissions.
            </HelpItemTitle>
          </HelpItem>
          <HelpItem>
            <HelpItemTitle>
              <strong>Real API:</strong> Use mock mode for testing and development. Enable real API only when ready for production use.
            </HelpItemTitle>
          </HelpItem>
          <HelpItem>
            <HelpItemText>
              For more information, visit our <HelpLink href="#docs">documentation</HelpLink> or contact <HelpLink href="#support">support</HelpLink>.
            </HelpItemText>
          </HelpItem>
        </HelpList>
      </HelpCard>
